...
//For information on the stdafx.h, read this stackoverflow thread: http://stackoverflow.com/questions/4726155/whats-the-use-for-stdafx-h-in-visual-studio 
#include "stdafx.h"
...
//standard input/output stream objects are defined in iostream
#include <iostream>

//All the OpenCV classes and functions are placed into the cv namespace 
using namespace cv;
//All classes and functions from the C++ standard library are places into the std namespace
using namespace std;
...
//----------------
	...
	image = imread("liverpool.jpg", CV_LOAD_IMAGE_COLOR);
...
//----------------
	...
	//Write the image to file
	imwrite("thres_image.jpg", thres_image);
...
//Visual Studio 2012 tutorial (by Diane Theriault, who taught CS585 in the Spring): http://cs-people.bu.edu/deht/CS585/VSTutorial/